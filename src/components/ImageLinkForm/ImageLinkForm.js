...
import './css/ImageLinkForm.css'
 const ImageLinkForm = ({onSearchChange,onButtonClick,error}) => {
  if(error) {
  	  return (
	  <div className='center mt3 w-60 shadow-5 pa3 background ba b--light-green flex-wrap'>
  ...
  return (
	  <div className='center mt3 w-60 shadow-5 pa3 background ba b--light-green '>
