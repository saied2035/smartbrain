...
import './css/ImageLinkForm.css'
 const ImageLinkForm = ({onSearchChange,onButtonClick,error}) => {
  if(error) {
  	  return (
	  <div style={{width:'70vw', height : 'auto'}} className='center mt3 shadow-5 pa3 background ba b--light-green flex-wrap'>
  ...
  return (
	  <div style={{width:'70vw', height:'auto'}} className='center mt3 shadow-5 pa3 background ba b--light-green '>
